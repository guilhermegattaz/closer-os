      ...
      <div className="container">
        <div className="problema-grid">
          <div className="problema-left">
            ...
            <p className="body-lg fade-up d2" style={{ margin: '0 0 16px' }}>
              Mas existe uma parte que ninguém te ensinou: <span style={{ textDecoration: 'underline', textDecorationColor: '#f9f8ff' }}>o que fazer antes de alguém se tornar seu cliente.</span>
            </p>
