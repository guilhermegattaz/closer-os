        ...
        <div className="problema-grid">
          <div className="problema-left">
            ...
            <h2 className="h2 fade-up d1" style={{ marginBottom: 12 }}>
              Você é excelente no que faz.<br className="br-desktop" />{' '}Mas na hora de vender, <span style={{ color: 'var(--accent-violet)' }}>algo trava.</span>
            </h2>
  ...
  return (
    <section id="problema">
      ...
      <p className="body-lg fade-up" style={{ fontStyle: 'italic', color: 'var(--text-2)', textAlign: 'center', maxWidth: 680, margin: '0 auto', padding: '40px 24px 0' }}>
        E o pior nem é a venda perdida. É deitar à noite remoendo a conversa, sabendo exatamente o que você devia ter dito — tarde demais.
      </p>
      <p className="body-lg fade-up" style={{ fontStyle: 'italic', color: 'var(--text-2)', textAlign: 'center', maxWidth: 680, margin: '0 auto', padding: '16px 24px 0' }}>
        É se sentir um amador justo na parte que decide o seu dinheiro, sendo você referência em todo o resto.
      </p>
