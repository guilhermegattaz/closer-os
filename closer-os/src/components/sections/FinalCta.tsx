    ...
    <section id="final-cta">
      <div className="final-cta-card fade-up">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
            <a href={KIWIFY_URL} className="btn-white" target="_blank" rel="noopener noreferrer" aria-label="Sim, quero parar de improvisar — R$67">Sim, quero parar de improvisar — R$67 →</a>
            <p className="oferta-risco-zero" style={{ textAlign: 'center', maxWidth: 400 }}>Você arrisca R$67 por 7 dias. Se o CloserOS™ não te ajudar a conduzir melhor suas conversas com clientes, é só pedir o reembolso.</p>
