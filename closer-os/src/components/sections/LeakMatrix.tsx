    ...
    <section id="leak">
      <div className="container">
        <div className="leak-header fade-up">
          ...
          <h2 className="h2">A maioria das vendas não morre no preço.<br /> <span className="hl-wrap text-gradient">Morre na resposta errada.</span><br /> <span className="hl-wrap text-gradient">completamente diferente.</span></h2>
